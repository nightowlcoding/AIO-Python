...
2026-03-02,12345,Coca-Cola 12oz,8</pre>
        ...
        <div id="aihelp" class="tab-content">
            ...
            <div style="background: #f8f9fa; border: 2px solid #dee2e6; border-radius: 10px; padding: 15px;">
                ...
                <div id="aiHelpResponse" style="white-space: pre-wrap; line-height: 1.5; color: #495057; min-height: 60px;">
Ask a question and the assistant will respond here.
    ...
    <script>
        ...
        function clearAIHelp() {
            ...
            document.getElementById('aiHelpResponse').textContent = 'Ask a question and the assistant will respond here.';
        ...
        function askAIHelp() {
            ...
            statusDiv.style.background = '#d1ecf1';
            statusDiv.style.color = '#0c5460';
            statusDiv.textContent = 'Getting AI help...';
            ...
            .then(result => {
                if (result.success) {
                    statusDiv.style.background = '#d4edda';
                    statusDiv.style.color = '#155724';
                    statusDiv.textContent = 'AI response ready';
                    responseDiv.innerHTML = escapeHtml(result.reply);
                } else {
                    statusDiv.style.background = '#f8d7da';
                    statusDiv.style.color = '#721c24';
                    statusDiv.textContent = result.message || 'Unable to get AI help right now.';
                    responseDiv.textContent = '';
                }
            })
            .catch(error => {
                ...
                statusDiv.style.background = '#f8d7da';
                statusDiv.style.color = '#721c24';
                statusDiv.textContent = 'Error contacting AI help endpoint.';
                responseDiv.textContent = '';
            });
        }
